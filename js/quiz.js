...
function showResult() {
    ...
    if (selectedQualities.length === 0 || !selectedSuperpower || !selectedWeapon || !selectedColor) {
    ...
    document.getElementById('result').innerHTML = 'You are ' + result.name + '!<br><img src="' + result.img + '" alt="' + result.name + '">';
